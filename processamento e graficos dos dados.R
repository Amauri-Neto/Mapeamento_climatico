#carregar os pacotes
pacman::p_load('raster','ggplot2','ggspatial', 'tidyverse',"TSA","tseries", "astsa" , "forecast")
...
setwd('C:/Users/Amauri/Desktop/dados wordclim/wc2.1_cruts4.06_2.5m_prec_1980-1989')
...
#grafico espacial
mapa1 = ggplot() +
  geom_tile(data = raster_df, aes(x = x, y = y, fill = as.numeric(layer))) +  # Converte para numérico
  ...
  #geom_path(data = shapefile_data, aes(x = long, y = lat, group = group), color = "black", size = 0.7) +# Define branco para valores NA
  labs(x = "Longitude", y = "Latitude", fill = "chuva em mm") +  # Adiciona rótulos aos eixos e à legenda de cores
  ggtitle("precipitação média no cariri paraibano entre 1980 e 1989",) +
  #annotation_north_arrow()+
  annotation_scale(location= 'br')+
  #coord_equal() +  # Para manter a proporção dos eixos
...
#para 1990
#definir o local dos arquivos.
setwd('C:/Users/Amauri/Desktop/dados wordclim/wc2.1_cruts4.06_2.5m_prec_1990-1999')
...
mapa2 = ggplot() +
  ...
  #geom_path(data = shapefile_data, aes(x = long, y = lat, group = group), color = "black", size = 0.7) +# Define branco para valores NA
  labs(x = "Longitude", y = "Latitude", fill = "chuva em mm") +  # Adiciona rótulos aos eixos e à legenda de cores
  ggtitle("Precipitação média no cariri paraibano entre 1990 e 1999",) +
  #annotation_north_arrow()+
  annotation_scale(location= 'br')+
  #coord_equal() +  # Para manter a proporção dos eixos
  theme_minimal()  # Remover todos os elementos do tema
...
#para 2000
#definir o local dos arquivos.
setwd('C:/Users/Amauri/Desktop/dados wordclim/wc2.1_cruts4.06_2.5m_prec_2000-2009')
...
mapa3 = ggplot() +
  ...
  #geom_path(data = shapefile_data, aes(x = long, y = lat, group = group), color = "black", size = 0.7) +# Define branco para valores NA
  labs(x = "Longitude", y = "Latitude", fill = "chuva em mm") +  # Adiciona rótulos aos eixos e à legenda de cores
  ggtitle("Precipitação média no cariri paraibano entre 2000 e 2009",) +
  #annotation_north_arrow()+
  annotation_scale(location= 'br')+
  #coord_equal() +  # Para manter a proporção dos eixos
  theme_minimal()  # Remover todos os elementos do tema
...
#para 2010
#definir o local dos arquivos.
setwd('C:/Users/Amauri/Desktop/dados wordclim/wc2.1_cruts4.06_2.5m_prec_2010-2019')
...
mapa4 = ggplot() +
  ...
  #geom_path(data = shapefile_data, aes(x = long, y = lat, group = group), color = "black", size = 0.7) +# Define branco para valores NA
  labs(x = "Longitude", y = "Latitude", fill = "chuva em mm") +  # Adiciona rótulos aos eixos e à legenda de cores
  ggtitle("Precipitação média no cariri paraibano entre 2010 e 2020",) +
  #annotation_north_arrow()+
  annotation_scale(location= 'br')+
  #coord_equal() +  # Para manter a proporção dos eixos
  theme_minimal()  # Remover todos os elementos do tema
...
ggsave("precipitacao_1980.png", plot = mapa1, width = 10, height = 6, dpi = 300)
ggsave("precipitacao_1990.png", plot = mapa2, width = 10, height = 6, dpi = 300)
ggsave("precipitacao_2000.png", plot = mapa3, width = 10, height = 6, dpi = 300)
ggsave("precipitacao_2010.png", plot = mapa4, width = 10, height = 6, dpi = 300)
ggsave("serie_precipitacao.png", plot = linha, width = 10, height = 6, dpi = 300)
