...
setwd('C:/Users/Amauri/Desktop/dados wordclim/wc2.1_cruts4.06_2.5m_Tmax_1980-1989')
...
mapa1 = ggplot() +
  ...
  ggtitle("Temperatura máxima no cariri paraibano entre 1980 e 1989",) +
...
#para 1990
#definir o local dos arquivos.
setwd('C:/Users/Amauri/Desktop/dados wordclim/wc2.1_cruts4.06_2.5m_Tmax_1990-1999')
...
mapa2 = ggplot() +
  ...
  #geom_path(data = shapefile_data, aes(x = long, y = lat, group = group), color = "black", size = 0.7) +# Define branco para valores NA
  labs(x = "Longitude", y = "Latitude", fill = "temperatura") +  # Adiciona rótulos aos eixos e à legenda de cores
  ggtitle("Temperatura máxima no cariri paraibano entre 1990 e 1999",) +
  #annotation_north_arrow()+
  annotation_scale(location= 'br')+
  #coord_equal() +  # Para manter a proporção dos eixos
  theme_minimal()  # Remover todos os elementos do tema
...
#para 2000
#definir o local dos arquivos.
setwd('C:/Users/Amauri/Desktop/dados wordclim/wc2.1_cruts4.06_2.5m_Tmax_2000-2009')
...
mapa3 = ggplot() +
  ...
  #geom_path(data = shapefile_data, aes(x = long, y = lat, group = group), color = "black", size = 0.7) +# Define branco para valores NA
  labs(x = "Longitude", y = "Latitude", fill = "temperatura") +  # Adiciona rótulos aos eixos e à legenda de cores
  ggtitle("Temperatura máxima no cariri paraibano entre 2000 e 2009",) +
  #annotation_north_arrow()+
  annotation_scale(location= 'br')+
  #coord_equal() +  # Para manter a proporção dos eixos
  theme_minimal()  # Remover todos os elementos do tema
...
#para 2010
#definir o local dos arquivos.
setwd('C:/Users/Amauri/Desktop/dados wordclim/wc2.1_cruts4.06_2.5m_Tmax_2010-2019')
...
mapa4 = ggplot() +
  ...
  #geom_path(data = shapefile_data, aes(x = long, y = lat, group = group), color = "black", size = 0.7) +# Define branco para valores NA
  labs(x = "Longitude", y = "Latitude", fill = "temperatura") +  # Adiciona rótulos aos eixos e à legenda de cores
  ggtitle("temperatura máxima no cariri paraibano entre 2010 e 2020",) +
  #annotation_north_arrow()+
  annotation_scale(location= 'br')+
  #coord_equal() +  # Para manter a proporção dos eixos
  theme_minimal()  # Remover todos os elementos do tema
...
linha=ggplot(data = serie_df,aes(x=data,y=valor))+
  ...
  theme_bw()+
  ggtitle('série temporal das temperaturas máximas no cariri ocidental')+
  labs(x='Tempo', y= 'chuva em milimetros')

#salvando os graficos

setwd('C:/Users/Amauri/Desktop/arquivos pibic')
ggsave("tmax_1980.png", plot = mapa1, width = 10, height = 6, dpi = 300)
ggsave("tmax_1990.png", plot = mapa2, width = 10, height = 6, dpi = 300)
ggsave("tmax_2000.png", plot = mapa3, width = 10, height = 6, dpi = 300)
ggsave("tmax_2010.png", plot = mapa4, width = 10, height = 6, dpi = 300)
ggsave("serie_tmax_reg.png", plot = linha, width = 10, height = 6, dpi = 300)
